...
namespace :db do
  ...
  migrations_directory = '/home/m/dev/railsapi/3_sinatra_pg/db/migrations'
  connection_string = ENV['DATABASE_URL'] ||
  ...
  task :seed do
    ...
    Sequel::Seeder.apply(DB, '/home/m/dev/railsapi/3_sinatra_pg/seeds') # Apply the seeds/fixtures
  end
